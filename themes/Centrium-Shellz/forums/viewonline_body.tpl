...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    <td class="catSides" colspan="3" height="25"><span class="cattitle"><strong>{TOTAL_REGISTERED_USERS_ONLINE}</strong></span></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <tr> 
    <td class="catSides" colspan="3" height="25"><span class="cattitle"><strong>{TOTAL_GUEST_USERS_ONLINE}</strong></span></td>
  </tr>
