...
<!-- BEGIN staff -->
  <tr> 
        <td valign="top" class="row1" nowrap="nowrap"><span class="postdetails"><a href="{staff.U_NAME}" class="genmed">{staff.NAME}</a><br /><br />{staff.LEVEL}<br />{staff.RANK}<br />{staff.RANK_IMAGE}<br />{staff.AVATAR}</span></td>
        <td valign="top" class="row2" nowrap="nowrap"><span class="genmed">{staff.FORUMS}</span>&nbsp;</td>
        <td valign="top" align="right" class="row1" nowrap="nowrap"><span class="gensmall">{staff.POSTS}&nbsp;&nbsp;<br />{staff.POST_PERCENT}&nbsp;&nbsp;<br />{staff.POST_DAY}&nbsp;<br />[{staff.LAST_POST}]</span>&nbsp;</td>
