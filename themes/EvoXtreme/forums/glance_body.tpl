...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundColor='#cccccc'" onmouseout="this.style.backgroundColor='#e0e0e0'"><span class="genmed"><a href="{news.TOPIC_LINK}" class="genmed">{news.TOPIC_TITLE}</a></span></td>
...
&nbsp;
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundColor='#cccccc'" onmouseout="this.style.backgroundColor='#e0e0e0'"><span class="genmed"><a href="{recent.TOPIC_LINK}" class="genmed">{recent.TOPIC_TITLE}</a></span></td>
