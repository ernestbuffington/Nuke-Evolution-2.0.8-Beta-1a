...
<table border="0" cellpadding="3" cellspacing="1" width="660" class="forumline" align="center">
    ...
    <tr>
        ...
        <td class="row2" width="530" align="center">{BB_BOX}</td>
    </tr>
    <tr> 
        ...
        <td class="row2" width="530" align="center"><textarea name="signature" style="width: 450px" rows="8" cols="70" class="post">{SIGNATURE}</textarea></td>
    </tr>
    <tr> 
        <td class="row1" width="130" height="20">&nbsp;</td>
        <td class="row2" width="530" align="center">
...
<table border="0" cellpadding="3" cellspacing="1" width="660" class="forumline" align="center">
    ...
    <tr> 
        <td class="row1" width="130" height="150"><span class="gen">{L_SIGNATURE}:</span><br /><span class="gensmall">{L_SIGNATURE_EXPLAIN}<br /><br />{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
        <td class="row2" width="530" align="center"><textarea name="signature" style="width: 450px" rows="8" cols="70" class="post">{PREVIEW}</textarea></td>
    </tr>
    <tr> 
        <td class="row1" width="130" height="20">&nbsp;</td>
        <td class="row2" width="530" align="center">
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline" align="center">
    ...
    <tr> 
        <td class="row1" valign="middle" align="center" height="50"><span class="gen">{SAVE_MESSAGE}</span></td>
    </tr>
    <tr> 
