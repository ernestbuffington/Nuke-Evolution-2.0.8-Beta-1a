...
$row = "<tr>"
         ...
         ."<td width=\"100%\" class=\"$row_class\"><a href=\"modules.php?name=Forums&amp;file=viewtopic&amp;p=$topic_first_post_id#$topic_first_post_id\">$topic_title</a></td>"
         ."<td align=\"center\" class=\"$row_class\"><a href=\"modules.php?name=Forums&amp;file=viewforum&amp;f=$forum_id\">$forum_name</a></td>"
         ."<td align=\"center\" class=\"$row_class\"><a href=\"modules.php?name=Forums&amp;file=profile&amp;mode=viewprofile&amp;u=$user_id\">$username</a></td>"
...
function make_table($posts, $announcements, $SplitAnnouncements) {
    ...
    $table .= "<tr>"
             ."<td height=\"28\" colspan=\"7\" align=\"right\" class=\"catBottom\">[ <a href=\"modules.php?name=Forums&amp;file=recent\">Recent Topics</a> ]&nbsp;</td>"
           ."</tr>"
         ."</table></td>"
         ."</tr>"
       ."</table></td>"
