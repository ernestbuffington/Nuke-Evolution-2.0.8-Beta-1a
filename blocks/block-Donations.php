...
function donation_block_make_image_button () {
    ...
    if (empty($block_block_configs['button_image'])) {
        ...
        return "<form action=\"modules.php?name=Donations&amp;op=make\" method=\"post\"><input type=\"image\" src=\"".$block_block_configs['button_image']."\" name=\"submit\" style=\"border: 0px;\" /></form>\n";
    }
}
