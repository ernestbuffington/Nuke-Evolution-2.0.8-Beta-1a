...
$content .= "<img src='images/blocks/uploads.png' height='16' width='16' alt='' /> <strong>"._DL_UP.":</strong><br />\n";
...
$content .= "<hr />\n";
$content .= "<img src='images/blocks/downloads.png' height='16' width='16' alt='' /> <strong>"._DL_DN.":</strong><br />\n";
...
$db->sql_freeresult($result);
$content .= "<img src='images/blocks/totals.png' height='16' width='16' alt='' /> <strong>"._DL_TDN.":</strong><br />\n";
