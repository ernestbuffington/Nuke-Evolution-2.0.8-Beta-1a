 ...
 ******************************************************/
    ...
    echo "<strong>".$usrcolor."'s "._MEMBERGROUPS.":</strong><br /><ul style=\"list-style: disc;\">\n";
/*****[END]********************************************
 [ Mod:    Advanced Username Color             v1.0.5 ]
 ******************************************************/
 ...
 ******************************************************/
        ...
        echo "<li><a href=\"modules.php?name=Groups&amp;g=$gid\">".$grpcolor."</a>".(is_mod_admin($module_name) ? '&nbsp;('.$gid.')' : '')."</li>";
/*****[END]********************************************
 [ Mod:    Group Colors                        v1.0.0 ]
 ******************************************************/
    }
