...
if (!defined('CNBYA')) {
    ...
    echo "<td width=\"25%\">&nbsp;</td><td><a href=\"modules.php?name=Private_Messages&amp;file=index&amp;folder=outbox\"><img src=\"$imagedir/msg_outbox.gif\" style=\"border:none;\" alt=\""._YAOUTBOX."\" /></a></td>";
