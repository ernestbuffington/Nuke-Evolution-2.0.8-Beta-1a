...
if($supporter_config['image_type']==0) { $type = "type='text'"; } else { $type = "type='file'"; }
...
echo "<tr><td><strong>"._SP_YOURNAME.":</strong></td><td><input type='text' name='user_name' size='40' /></td></tr>\n";
