...
if($sp_config['require_user'] == 0 || is_user()) {
  ...
  if (is_mod_admin($userinfo['username'],$module_name)) {
  ...
  if($sp_config['image_type']==0) { $type = "type='text'"; } else { $type = "type='file'"; }
  ...
  echo "<tr><td><strong>"._SP_YOURNAME.":</strong></td><td><input type='text' name='user_name' value='$sname' size='40' /></td></tr>\n";
