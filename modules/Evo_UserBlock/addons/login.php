...
function evouserinfo_login () {
   global $lang_evo_userblock, $evouserinfo_login;
	...
	$evouserinfo_login .= "<input type=\"hidden\" name=\"op\" value=\"login\" />";
	if (!empty($redirect)){
    ...
    $evouserinfo_login .= "<img src=\"images/evo_userinfo/arrow.gif\" alt=\"\" style=\"vertical-align: middle\" />\n";
    ...
    $evouserinfo_login .= "<tr><td align=\"center\">".$lang_evo_userblock['BLOCK']['LOGIN']['PASSWORD']."<br /><input type=\"password\" name=\"user_password\" size=\"15\" maxlength=\"20\" /></td></tr>\n";
    /*****[BEGIN]******************************************
