...
function evouserinfo_posts () {
    ...
    $evouserinfo_posts .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['POSTS']['POSTS'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($posts)."<br />\n";
    $evouserinfo_posts .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['POSTS']['TOPICS'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($topics)."<br />\n";
    if (is_user()) {
        global $userinfo;
        $evouserinfo_posts .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['POSTS']['UR_TOPICS'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".evouserinfo_ur_total_topics()."<br />\n";
        $evouserinfo_posts .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['POSTS']['UR_POSTS'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($userinfo['user_posts'])."<br />\n";
    }
