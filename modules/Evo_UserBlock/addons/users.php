...
function evouserinfo_users () {
    ...
    $evouserinfo_users .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['USERS']['NEW_TODAY'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($today)."<br />\n";
    $evouserinfo_users .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['USERS']['NEW_YESTERDAY'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($yesterday)."<br />\n";
    $evouserinfo_users .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['USERS']['WAITING'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($waiting)."<br />\n";
    $evouserinfo_users .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['USERS']['TOTAL'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;".number_format($total)."<br />\n";
    $evouserinfo_users .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['USERS']['LATEST'].$lang_evo_userblock['BLOCK']['BREAK']."&nbsp;<strong>".$new_user."</strong><br />\n";
