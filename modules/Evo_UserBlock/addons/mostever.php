...
$evouserinfo_mostever .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['ONLINE']['GUESTS'].$lang_evo_userblock['BLOCK']['ONLINE']['BREAK']."&nbsp;".number_format($block_mostever['nonmembers'])."<br />\n";
$evouserinfo_mostever .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['ONLINE']['MEMBERS'].$lang_evo_userblock['BLOCK']['ONLINE']['BREAK']."&nbsp;".number_format($block_mostever['members'])."<br />\n";
$evouserinfo_mostever .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$lang_evo_userblock['BLOCK']['ONLINE']['TOTAL'].$lang_evo_userblock['BLOCK']['ONLINE']['BREAK']."&nbsp;".number_format($block_mostever['total']).evouserinfo_expand_collapse_end()."\n";
