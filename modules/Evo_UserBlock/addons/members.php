...
function evouserinfo_members () {
    ...
    if ($db->sql_numrows($result) == 0) {
          $evouserinfo_members .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;"._GRNONE."<br />\n";
    } else {
        while(list($group_name) = $db->sql_fetchrow($result)) {
            $group_name = GroupColor($group_name);
            $evouserinfo_members .= "<img src=\"images/evo_userinfo/li.png\" style=\"vertical-align: middle\" alt=\"\" />&nbsp;".$group_name."<br />\n";
        }
