...
function plans() {
    ...
    if ($db->sql_numrows($result) > 0) {
        ...
        echo "<tr><td align=\"center\" nowrap=\"nowrap\" bgcolor=\"$bgcolor2\"><strong>"._PLANNAME."</strong></td><td bgcolor=\"$bgcolor2\">&nbsp;<strong>"._DESCRIPTION."</strong></td><td align=\"center\" bgcolor=\"$bgcolor2\"><strong>"._QUANTITY."</strong></td><td align=\"center\" bgcolor=\"$bgcolor2\"><strong>"._PRICE."</strong></td><td align=\"center\" bgcolor=\"$bgcolor2\" nowrap=\"nowrap\"><strong>"._BUYLINKS."</strong></td></tr>";
        while ($row = $db->sql_fetchrow($result)) {
            ...
            echo "<tr><td valign=\"top\"><strong>".$row['name']."</strong></td><td>".$row['description']."</td><td valign=\"bottom\"><center>".$row['delivery']."<br />$delivery</center></td><td valign=\"bottom\">".$row['price']."</td><td valign=\"bottom\" nowrap=\"nowrap\"><center>".$row['buy_links']."</center></td></tr>";
        }
...
function client() {
    ...
    if (is_client($client)) {
        ...
        echo "<tr><td>&nbsp;</td><td><input type=\"hidden\" name=\"op\" value=\"client_valid\" /><input name=\"submit\" type=\"submit\" value=\""._ENTER."\" /></td></tr></table></form>";
        CloseTable();
        themenu();
        include_once(NUKE_BASE_DIR.'footer.php');
    }
