...
global $prefix, $db, $admin_file, $userinfo;
...
if (is_mod_admin($module_name)){
    ...
    function BannersAdmin() {
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            echo "<tr><td bgcolor=\"$bgcolor1\" align=center>".$row['name']."</td>"
    ...
    function ad_plans() {
        ...
        echo "<tr><td>"._INITIALSTATUS.":</td><td><input type=\"radio\" name=\"status\" value=\"1\" checked=\"checked\" /> "._ACTIVE." &nbsp;&nbsp; <input type=\"radio\" name=\"status\" value=\"0\" /> "._INACTIVE."</td></tr>";
