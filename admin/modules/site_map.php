                    ...
                    <table border="0" width="588" id="table7" >
                        <tr>
                            <td width="146" height="102">
                                <p align="left">'._XMLCREATE.'</p></td>
                            <td height="102">';
        if($xml==1) {
            echo'<p align="left">'._YES.'<input name="xml" type="radio" value="1" checked="checked" />
                                                '._NO.'<input name="xml" type="radio" value="0" /></p>';
        }
        else {
            echo'<p align="left">'._YES.'<input name="xml" type="radio" value="1" >
                                                '._NO.'<input name="xml" type="radio" value="0" checked="checked" /></p>';
        }
            echo'            </td>
                            <td height="102">
                                <p align="left">'._NDOWN.'</p></td>
                            <td height="102">
