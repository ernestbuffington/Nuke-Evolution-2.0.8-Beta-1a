...
global $prefix, $db, $bgcolor2, $sitename, $bgcolor1, $prefix, $language, $multilingual, $user, $admin, $bgcolor, $admin_file, $user_prefix, $admdata, $nsnst_const, $userinfo;
...
echo ("<center><img src=\"images/4nwho/group-3.gif\" height=\"14\" width=\"17\" alt=\"" . _4nwho03 . "\" />" . _4nwho03 . "</center><br />");
    CloseTable();
echo ("<br />");
    OpenTable();
echo ("<center><img src=\"images/4nwho/info.gif\" border=\"0\" alt=\"" . _4nwho13 . "\" />&nbsp;=&nbsp;" . _4nwho13 . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"images/4nwho/edit.gif\" border=\"0\" alt=\"" . _4nwho08 . "\" />&nbsp;=&nbsp;" . _4nwho08 . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"images/4nwho/delete.gif\" border=\"0\" alt=\"" . _4nwho20 . "\" />&nbsp;=&nbsp;" . _4nwho20 . "</center>");
 ...
 ******************************************************/
        $uname = "<img src=\"images/4nwho/ur-member.gif\" border=\"0\" alt=\"$uname\" />&nbsp;$usercolor&nbsp;&nbsp;<a href=\"modules.php?name=Your_Account&amp;op=userinfo&amp;username=$uname\"><img src=\"images/4nwho/info.gif\" border=\"0\" alt=\"" . _4nwho13 . "\" /></a><a href=\"modules.php?name=Your_Account&amp;file=admin&amp;op=modifyUser&amp;chng_uid=$uname\"><img src=\"images/4nwho/edit.gif\" border=\"0\" alt=\"" . _4nwho08 . "\" /></a>&nbsp;<a href=\"modules.php?name=Your_Account&amp;file=admin&amp;op=deleteUser&amp;chng_uid=$uname\"><img src=\"images/4nwho/delete.gif\" border=\"0\" alt=\"" . _4nwho20 . "\" /></a>";
/*****[END]********************************************
 [ Mod:    CNBYA Modifications                 v1.0.0 ]
 ******************************************************/
}
if($guest == 1) {
        $uname = "<img src=\"images/4nwho/ur-anony.gif\" border=\"0\" alt=\"" . _4nwho14 . "\" />&nbsp;" . _4nwho14 . "";
}
if($guest == 3) {
        $uname = "<img src=\"images/4nwho/ur-anony.gif\" border=\"0\" alt=\"".$nsnst_const['searchbot']."\" />&nbsp;".$nsnst_const['searchbot'];
}
...
if($guest == 0 || $guest == 2) {
    echo ("<td><img src=\"images/4nwho/green_dot.gif\" alt=\"\" />&nbsp;&nbsp;$host_addr</td><td bgcolor=\"$bgcolor1\">");
}else{
    echo ("<td><img src=\"images/4nwho/red_dot.gif\" alt=\"\" />&nbsp;&nbsp;$host_addr</td><td bgcolor=\"$bgcolor1\">");
}
echo ("<img src=\"images/4nwho/star.gif\" alt=\"\" />&nbsp;&nbsp;$host</td><td>");
if ( strstr($host, "aol")) {
    echo ("<img src=\"images/4nwho/center_l.gif\" alt=\"\" />&nbsp;&nbsp;America Online</td>");
} else {
    echo ("<img src=\"images/4nwho/center_l.gif\" alt=\"\" />&nbsp;&nbsp;$country</td>");
}
$unixtime = time() - $time;
if($unixtime < 60){
    $sec=$unixtime;
...
if($guest == 0 || $guest == 2) {
    echo ("<td bgcolor=\"$bgcolor1\"><img src=\"images/4nwho/green_dot.gif\" alt=\"\" />&nbsp;&nbsp;$hour hour : $min min : $sec sec </td>");
}else{
    echo ("<td bgcolor=\"$bgcolor1\"><img src=\"images/4nwho/red_dot.gif\" alt=\"\" />&nbsp;&nbsp;$hour hour : $min min : $sec sec </td>");
  }
}
echo ("</tr></table><br />");
