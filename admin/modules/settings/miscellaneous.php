...
global $httpref, $httprefmax, $pollcomm, $articlecomm, $minpass, $my_headlines, $user_news, $adminssl, $queries_count, $use_colors, $lock_modules, $banners, $lazy_tap, $wysiwyg, $img_resize, $img_width, $img_height, $collapse, $collapsetype, $analytics;
...
if(!isset($lazy_tap) || is_null($lazy_tap) || $lazy_tap == 0) {
     $tap_off = "checked='checked'";
} else if($lazy_tap == 1) {
     $tap_bots = "checked='checked'";
} else if($lazy_tap == 2) {
     $tap_all = "checked='checked'";
} else if($lazy_tap == 3) {
     $tap_admin = "checked='checked'";
}
