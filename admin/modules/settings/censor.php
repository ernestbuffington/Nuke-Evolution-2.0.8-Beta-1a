...
if($censor == 0) {
    echo "<input type='radio' name='xcensor' value='0' checked='checked' />" . _CENSOR_OFF . " &nbsp;"
    ...
    echo "<input type='radio' name='xcensor' value='0' />" . _CENSOR_OFF . " &nbsp;"
        ."<input type='radio' name='xcensor' value='1' checked='checked' />" . _CENSOR_WHOLE . " &nbsp;"
        ."<input type='radio' name='xcensor' value='2' />" . _CENSOR_PARTIAL . "";
} elseif($censor == 2) {
    echo "<input type='radio' name='xcensor' value='0' />" . _CENSOR_OFF . " &nbsp;"
        ."<input type='radio' name='xcensor' value='1' />" . _CENSOR_WHOLE . " &nbsp;"
        ."<input type='radio' name='xcensor' value='2' checked='checked' />" . _CENSOR_PARTIAL . "";
}
