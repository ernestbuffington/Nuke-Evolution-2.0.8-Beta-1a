...
function messages() {
    ...
    ."<td bgcolor=\"$bgcolor2\" align=\"center\" nowrap=\"nowrap\">&nbsp;<strong>" . _VIEW . "</strong>&nbsp;</td>"
 ...
 ******************************************************/
    ...
    echo "<tr><td align=\"right\"><strong>$mid</strong>"
        ...
        ."</td><td align=\"right\" nowrap=\"nowrap\">(<a href=\"".$admin_file.".php?op=editmsg&amp;mid=$mid\">" . _EDIT . "</a>-<a href=\"".$admin_file.".php?op=deletemsg&amp;mid=$mid\">" . _DELETE . "</a>)"
        ."</td></tr>";
