...
function displayadmins() {
    ...
    if (is_admin()) {
        ...
        if ($multilingual == 1) {
            ...
            echo "<option value=\"\">" . _ALL . "</option></select><input type=\"hidden\" name=\"add_admlanguage\" value=\"\" /></td></tr>";
        }
...
/*****[END]********************************************
 [ Mod:     Password Strength Meter            v1.0.0 ]
 ******************************************************/
        echo "<tr><td><input type=\"hidden\" name=\"op\" value=\"AddAuthor\" />"
            ."<input type=\"submit\" value=\"" . _ADDAUTHOR2 . "\" /></td></tr>"
            ."</table></form>";
        CloseTable();
...
function modifyadmin($chng_aid) {
    ...
    if (is_admin()) {
        ...
        if ($multilingual == 1) {
            ...
            echo "<option value=\"\" $allsel>" . _ALL . "</option></select><input type=\"hidden\" name=\"chng_admlanguage\" value=\"\" /></td></tr>";
        }
        echo "<tr><td>" . _PERMISSIONS . ":</td>";
        if ($row['name'] != 'God') {
            ...
            echo "</tr><tr><td>&nbsp;<input type=\"hidden\" name=\"auth_modules[]\" value=\"\" /></td>";
             $sel1 = 'checked';
        }
        echo "<td><input type=\"checkbox\" name=\"chng_radminsuper\" value=\"1\" $sel1 /> <strong>" . _SUPERUSER . "</strong></td>"
            ...
            ."<tr><td>" . _PASSWORD . ":</td>"
            ."<td colspan=\"3\"><input type=\"password\" name=\"chng_pwd\" size=\"12\" maxlength=\"40\" onkeyup='chkpwd(newauthor.chng_pwd.value)' onblur='chkpwd(newauthor.chng_pwd.value)' onmouseout='chkpwd(newauthor.chng_pwd.value)' /><br /><br /></td></tr>";
 ...
 ******************************************************/
        echo "</table><table width='300' cellpadding='2' cellspacing='0' border='1' bgcolor='#EBEBEB' style='border-collapse: collapse;'><tr>"
            ...
            ."<td id='td5' width='100' align='center'><div id='div5'></div></td>"
            ."</tr></table><div id='divTEMP'></div><table border=\"0\"><tr><td>\n";
        echo _PSM_CLICK." <a href=\"javascript:strengthhelp()\">"._PSM_HERE."</a> "._PSM_HELP."<br /><br /></td></tr>";
/*****[END]********************************************
 [ Mod:     Password Strength Meter            v1.0.0 ]
 ******************************************************/
       
        echo "<tr><td>" . _RETYPEPASSWD . ":</td>"
            ."<td colspan=\"3\"><input type=\"password\" name=\"chng_pwd2\" size=\"12\" maxlength=\"40\" /> <span class=\"tiny\">" . _FORCHANGES . "</span>"
            ."<input type=\"hidden\" name=\"adm_aid\" value=\"$adm_aid\" />"
            ."<input type=\"hidden\" name=\"op\" value=\"UpdateAuthor\" /></td></tr>"
