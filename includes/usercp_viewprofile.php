...
if (is_admin()) {
    ...
    if($profiledata['user_lastvisit'] != 0){
        echo "<center>"._LASTVISIT." <strong>".date($board_config['default_dateformat'],$profiledata['user_lastvisit'])."</strong></center>";
    } else {
        echo "<center>"._LASTVISIT." <strong>"._LASTNA."</strong></center>";
    }
    if ($profiledata['last_ip'] != 0) {
        echo "<center>"._LASTIP." <strong>".$profiledata['last_ip']."</strong><br /><br />";
        echo "[ <a href='".$admin_file.".php?op=ABBlockedIPAdd&amp;tip=".$profiledata['last_ip']."'>"._BANTHIS."</a> ]</center>";
    }
    echo "<center>[ <a href=\"modules.php?name=Your_Account&amp;file=admin&amp;op=suspendUser&amp;chng_uid=".$profiledata['user_id']."\">"._SUSPENDUSER."</a> ] ";
    echo "[ <a href=\"modules.php?name=Your_Account&amp;file=admin&amp;op=deleteUser&amp;chng_uid=".$profiledata['user_id']."\">"._DELETEUSER."</a> ]</center>";
}
global $currentlang;
