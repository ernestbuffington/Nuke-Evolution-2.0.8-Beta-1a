 ...
 ******************************************************/
	...
	// Javascript fix for XHTML compliance
	$boxstring .= "<script type=\"text/javascript\">
	//<![CDATA[
    ...
    if ( $total_categories = count($category_rows) )
    {
        ...
        $boxstring .= '<select name="' . POST_FORUM_URL . '" onchange="switch_forum(this.value); return false;">';
...
//                    {
    ...
    {
        $boxstring .= '<select name="' . POST_FORUM_URL . '" onchange="switch_forum(this.value); return false;"></select>';
    }
